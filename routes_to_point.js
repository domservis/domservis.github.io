...
//
   ...
   iconImageHref: 'https://raw.githubusercontent.com/domservis/domservis.github.io/master/images/258.png', iconContent: " <div id='dot'><div style='background: url(https://raw.githubusercontent.com/domservis/domservis.github.io/master/images/258.png);' class='ping'></div></div><br><a href='#' id='mp'>открыть</a>", balloonContentHeader: "<center>{кнопка#1}:{кнопка#2}</center>",
